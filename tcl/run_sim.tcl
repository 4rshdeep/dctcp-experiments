...
# modified this for changed simulation
# run_time (sec)
# set run_time 10.0
# pktSize (bytes)
...
# $ns at 3.1 "$ftp(1) start"
# $ns at 6.1 "$ftp(2) start"
# $ns at 9.1 "$ftp(3) start"
# $ns at 12.1 "$ftp(4) start"

# $ns at 15.1 "$ftp(4) stop"
# $ns at 18.1 "$ftp(3) stop"
# $ns at 21.1 "$ftp(2) stop"
# $ns at 24.1 "$ftp(1) stop"
# $ns at 27.1 "$ftp(0) stop"
